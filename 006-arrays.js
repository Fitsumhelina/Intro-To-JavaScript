...
console.log('Modified on campus array:', myCampus); // Output: Modified fruits array: ['pear', 'banana', 'orange']

// Adding Elements
myCampus.push('ethiopia'); // Adding an element at the end
console.log('camous array after push:', myCampus); // Output: Fruits array after push: ['pear', 'banana', 'orange', 'grape']
...
console.log('campus array after pop:', myCampus); // Output: Fruits array after pop: ['pear', 'banana', 'orange']

// Iterating over Arrays
myCampus.forEach(function (list) {
